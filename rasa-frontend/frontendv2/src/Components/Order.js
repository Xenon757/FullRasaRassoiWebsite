...
const Order = ({}) => {
  ...
  return isMobile ? (
    <MobileViewOrder></MobileViewOrder>
  ) : (
    <DekstopViewOrder></DekstopViewOrder>
  );
};

const DekstopViewOrder = ({}) => {
    ...
    <>
      {showPayment ? (
        ...
        <>
              ...
              >
                ...
                >
                  <motion.img
                    ...
                    transition={{ duration: 0.05 }}
                  ></motion.img>
                  <div className="my-[20px] font-caveat text-[20px]">
                    {pindiCount}
                  </div>
                  <motion.img
                    src={require("./minus.png")}
          ...
          >
            <div className="text-center font-caveat text-3xl mt-[20px]">
              YOUR ORDER
            </div>
            <div className="border-t-[5px] border-dashed border-black my-5"></div>
            <div className="text-start ml-[20px] font-josefin">PINDI CHOLE</div>
